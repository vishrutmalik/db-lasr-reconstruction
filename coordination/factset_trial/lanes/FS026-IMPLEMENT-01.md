...
- Handoff checkpoint: `c0ce6edd00b9ee6e2289fda8097f5f1ea663a09b`.
...
- File modes restored to `100644`; branch/worktree clean and pushed.
...
The planned red-team must include: no cache/sender/ledger/telemetry activity on
exclusions (including force-refresh, pagination and batch); output-list
order/duplicate bypass; input/output direction separation; 401 live/cached
account abort; 403 policy inertness; later-success conflict; manifest
snapshot/hash forgery and deep immutability; exact benchmark selector
boundaries; path/method normalization; no fabricated history/membership; and
no all-skipped purchase PASS.
