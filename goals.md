...
| G006 | Full skills library (20 skills) | implementer | G005 | IN_VERIFICATION | [#6](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/6) | [#51](https://github.com/vishrutmalik/db-lasr-reconstruction/pull/51) |
...
| G013 | Field mapping: provider fields → model requirements | data-researcher | G011, G012 | IN_PROGRESS | [#13](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/13) | |
