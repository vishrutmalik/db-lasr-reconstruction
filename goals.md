...
| G024 | N-LASR 2012 weak learner + AdaBoost loop (formula-level tests) | implementer | G007, G023 | REMEDIATION | [#24](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/24) | [#70](https://github.com/vishrutmalik/db-lasr-reconstruction/pull/70) |
...
| G028 | Reporting & diagnostics (signal + portfolio metrics) | implementer | G026, G027 | IN_PROGRESS | [#28](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/28) | |
...
| G034 | Transaction-cost & borrow model | implementer | G027 | IN_RE-VERIFICATION | [#33](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/33) | [#67](https://github.com/vishrutmalik/db-lasr-reconstruction/pull/67) |
