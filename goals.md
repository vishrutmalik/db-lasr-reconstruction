...
| G024 | N-LASR 2012 weak learner + AdaBoost loop (formula-level tests) | implementer | G007, G023 | IN_VERIFICATION | [#24](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/24) | [#70](https://github.com/vishrutmalik/db-lasr-reconstruction/pull/70) |
...
| G026 | Walk-forward backtester (purge/embargo, event-time) | implementer | G023, G014 | IN_VERIFICATION | [#26](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/26) | [#69](https://github.com/vishrutmalik/db-lasr-reconstruction/pull/69) |
...
| G034 | Transaction-cost & borrow model | implementer | G027 | FAILED_VERIFICATION | [#33](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/33) | [#67](https://github.com/vishrutmalik/db-lasr-reconstruction/pull/67) |
