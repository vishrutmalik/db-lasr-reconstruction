...
| G013 | Field mapping: provider fields → model requirements | data-researcher | G011, G012 | READY | [#13](https://github.com/vishrutmalik/db-lasr-reconstruction/issues/13) | |
